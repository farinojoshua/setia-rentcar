          ...
          <div class="flex flex-col gap-[30px]">
            <div class="flex flex-col gap-4">
              ...
              <div class="flex items-center justify-between">
                ...
                <p class="text-base font-semibold">
                    {{ $booking->start_date->diffInDays($booking->end_date) }} day
                </p>
              </div>
              <!-- Items -->
              <div class="flex items-center justify-between">
              ...
              <div class="flex items-center justify-between">
                ...
                <p class="text-base font-semibold">
                  Rp.{{ $booking->car->price * $booking->start_date->diffInDays($booking->end_date) * (10 / 100) }}
                </p>
              </div>
              <!-- Items -->
              <div class="flex items-center justify-between">
